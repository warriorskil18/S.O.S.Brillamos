...
class sosMessage : AppCompatActivity(), OnMapReadyCallback {
    ...
    private val phoneNumber = "5574279252" // Número de teléfono de destino mensaje
    private val phoneNumber2 = "5565344548"
    private val phoneNumber3 = ""
    private val message = "Necesito asistencia inmediata. " // + coordenadas
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Verificar si se tiene el permiso necesario para enviar mensajes de texto
        if (ContextCompat.checkSelfPermission(
                this,
            ...
            ActivityCompat.requestPermissions(
                ...
                sosMessage.SMS_PERMISSION_REQUEST_CODE
            )
        } else {
            // Si se tiene el permiso, enviar el mensaje de texto
            sendMessage()
            Toast.makeText(this, "El mensaje ah sido enviado con exito", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun sendMessage() {
        ...
        val smsManager2: SmsManager = SmsManager.getDefault()
